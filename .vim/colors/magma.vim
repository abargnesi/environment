" Vim color file
" -----------------------------
" magma.vim - a dark reddish scheme, I just copied wombat256.vim
...
call <SID>X("Normal",		"d0d0d0",	"0000000",	"none")
...
" syntax highlighting
call <SID>X("Number",		"ffffff",	"",			"none")
call <SID>X("Constant",		"ffffff",	"",			"none")
call <SID>X("String",		"dd6060",	"",			"italic")
call <SID>X("Comment",		"808080",	"",			"italic")
call <SID>X("Identifier",	"b5ab6f",	"",			"none")
call <SID>X("Keyword",		"ffff00",	"",			"none")
call <SID>X("Statement",	"ff0000",	"",			"none")
